...
function seedDB(){
	//remov all campgrounds
	Campground.remove({},function(err){
		if(err){
			console.log("error");
		}else{
				console.log("removed all campgrounds successsfully");
			//add new campgrounds
			data.forEach(function(camp){
				Campground.create(camp,function(err,campground){
					if(err){
						...
						console.log("new campground created successsfully");
						Comment.create(
							{
								...
								if(err){
									...
									console.log("comment added successsfully");
									campground.comments.push(comment);
									campground.save(function(err,campground){
										if(err){
											console.log("error");
										}else{
											console.log("saved campground and comment");
										}
									})
								}
							}
